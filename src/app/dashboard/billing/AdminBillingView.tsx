...
export function AdminBillingView() {
  ...
  return (
    <div className="w-full max-w-full mx-auto flex flex-col gap-8 pb-32 animate-in fade-in-50 duration-500">
      ...
      <div className="p-6 sm:p-7 rounded-[2.5rem] bg-gradient-to-br from-slate-900 via-slate-800 to-slate-950 text-white shadow-2xl space-y-5 border border-white/10 mx-2 text-left relative overflow-hidden">
            ...
            <div className="flex flex-wrap items-center justify-between gap-4 p-4 rounded-2xl bg-slate-900 text-white shadow-lg">
                ...
                <div className="flex flex-wrap items-center gap-4">
                    ...
                    <div className="text-right hidden sm:block">
                        ...
                        <span className="text-base font-black text-amber-400 tracking-tighter">${filteredMetrics.totalRemaining.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                    </div>
                </div>
            </div>
        </div>
